...
frappe.ui.form.on("Insights", {
    before_save(frm) {
        validate_sequence(frm, "capabilities_detail", "Capabilities Detail");
        validate_sequence(frm, "functionality_detail", "Functionality Detail");
        validate_sequence(frm, "integration_detail", "Integration Detail");
        validate_sequence(frm, "services_detail", "Services Detail");
        validate_sequence(frm, "benefits_detail", "Benefits Detail");
        generate_url(frm);
    },
    title: function(frm) {
